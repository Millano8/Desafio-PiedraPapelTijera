var e=globalThis,t={},i={},n=e.parcelRequired1a4;null==n&&((n=function(e){if(e in t)return t[e].exports;if(e in i){var n=i[e];delete i[e];var s={id:e,exports:{}};return t[e]=s,n.call(s.exports,s,s.exports),s.exports}var a=Error("Cannot find module '"+e+"'");throw a.code="MODULE_NOT_FOUND",a}).register=function(e,t){i[e]=t},e.parcelRequired1a4=n),(0,n.register)("27Lyk",function(e,t){Object.defineProperty(e.exports,"register",{get:()=>i,set:e=>i=e,enumerable:!0,configurable:!0});var i,n=new Map;i=function(e,t){for(var i=0;i<t.length-1;i+=2)n.set(t[i],{baseUrl:e,path:t[i+1]})}}),n("27Lyk").register(new URL("",import.meta.url).toString(),JSON.parse('["dZpbI","index.a9ab0fad.js","3tOKg","perdiste.dcc11aeb.png","7spTd","ganaste.ab8c5652.png","l7cZy","Papel.a18e2c61.png","j9E4C","Piedra.083177db.png","hWexY","Tijera.a063bb16.png","1etes","img-explosion1.eed10714.jpg"]')),customElements.define("custom-button",class extends HTMLElement{constructor(){super(),this.shadow=this.attachShadow({mode:"open"})}connectedCallback(){let e=document.createElement("style");e.innerHTML=`
    ...
    `,this.shadow.appendChild(e),this.render()}render(){let e=r.getState().currentGame.computerPlay,t=document.createElement("div");"tijeras"===e?t.innerHTML=`
        ...
        `,this.shadow.appendChild(e),this.render()}render(){let e=document.createElement("button");e.textContent=this.textContent,e.className="root",this.shadow.appendChild(e)}});let m="";var h={};h=new URL("img-explosion1.eed10714.jpg",import.meta.url).toString();const g="Desafio-PiedraPapelTijera/";function v(){return location.host.includes("github.io")}const f=[{path:/\/Desafio-PiedraPapelTijera\/juego/,component:function(e){let t=document.createElement("div");t.className="init-juego";let i=new URL(o),n=new URL(l),s=new URL(d);t.innerHTML=`
    ...
    `;let i=t.querySelector(".init-instructions__button");i?.addEventListener("click",()=>{e.goTo("/juego")});let n=t.querySelector(".init-instructions__reset-button");return n?.addEventListener("click",()=>{r.restartGame()}),t}},{path:/\/Desafio-PiedraPapelTijera\/inicio/,component:function(e){let t=document.createElement("div");t.className="init-page",t.innerHTML=`
    ...
    `;let i=t.querySelector(".boton-inicio");return i?.addEventListener("click",()=>{e.goTo("/instructions")}),t}},{path:/\/Desafio-PiedraPapelTijera\/resultadoGanaste/,component:function(e){let t=document.createElement("div");t.className="res-ganaste",t.innerHTML=`
    ...
    `;let i=t.querySelector("button-volver-jugar");return i?.addEventListener("click",()=>{e.goTo("/instructions")}),t}},{path:/\/Desafio-PiedraPapelTijera\/resultadoPerdiste/,component:function(e){let t=document.createElement("div");t.className="res-perdiste",t.innerHTML=`
    ...
    `;let i=t.querySelector("button-volver-jugar");return i?.addEventListener("click",()=>{e.goTo("/instructions")}),t}},{path:/\/Desafio-PiedraPapelTijera\/pelea/,component:function(e){let t=document.createElement("div");t.className="init-pelea";let i=new URL(o),n=new URL(l),s=new URL(d),a=new URL(h),c=r.getState(),p=m;r.computerPlay(),"tijeras"==p?(r.setMove("tijeras"),t.innerHTML=`
        ...
        `):"piedra"==p&&(r.setMove("piedra"),t.innerHTML=`
            ...
            `),r.whoWins(c.currentGame.myPlay,c.currentGame.computerPlay);let u=c.currentGame.resultado;return r.countPoints(u),r.getHistory(),setTimeout(()=>{"ganaste"==u?e.goTo("/resultadoGanaste"):"perdiste"==u?e.goTo("/resultadoPerdiste"):e.goTo("/juego")},3e3),t}}];!function(e){function t(e){let t=v()?g+e:e;history.pushState({},"",t),i(t)}function i(i){console.log("El handleRoute recibio una nueva ruta",i);let n=v()?i.replace(g,""):i;for(let i of f)if(i.path.test(n)){let n=i.component({goTo:t});e.firstChild&&e.firstChild.remove(),e.appendChild(n)}}"/"==location.pathname?t("/Desafio-PiedraPapelTijera/inicio"):t(location.pathname),window.onpopstate=function(){i(location.pathname)}}(document.querySelector(".root"));
//# sourceMappingURL=index.a9ab0fad.js.map
